...
ell = zeros(1, Np);
T   = zeros(1, Np);
det = zeros(1, Np, 'uint8');   % 0=reset, 1=monitor, 2=detected

tau_det = Np;
missed  = true;

%% ========================================================================
%  INIT AT PING 1 (H0 + optional H1)
%  ========================================================================
...
for k = 2:Np
    ...
    % --------------------------------------------------------------------
    % Re-init both filters if requested (your design: when Tk resets to 0)
    % --------------------------------------------------------------------
